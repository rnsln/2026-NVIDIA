...
### 🛠️ CPU-GPU-MGPU-MQPU and Precisions
We benchmarked GPU, Multi-GPU, and Multi-QPU with FP32-FP64 precisions for each. Because of the limited credit, we couldn't test more options. The results of the tests were the real Pole Star.
**Scalable MGPU and fastest MQPU!**
### 🚀 CuPy Supercharge
...
* **Web Interface**: Node.js + Express backend to orchestrate Python solvers.
...
## 🚀 How to Run locally the website
...
```bash
# Start the web server (accessed via localhost:3000)
npm run start
```
